...
The User Manual can be downloaded as a PDF file. The content corresponds to the help included in the program package. Chapter 2.3 Upgrades includes hints for upgrading from a previous version.
